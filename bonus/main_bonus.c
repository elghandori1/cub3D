...
void	initialize_sound(t_game *game)
{
	...
	game->audio.sound_track = cs_load_wav("./textures/e1m1.wav", NULL);
	game->audio.gun_sound = cs_load_wav("./textures/weapon_pistol.wav", NULL);
	game->audio.door_sound[0] = cs_load_wav("./textures/door_open.wav", NULL);
	game->audio.door_sound[1] = cs_load_wav("./textures/door_close.wav", NULL);
	game->door_open = -1;
